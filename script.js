...
class Factory {
  constructor (make, madeIn, airbags, abs, warrenty){
    this.make = "Mazda";
    this.madeIn = "USA";
    this.airbags = true;
    this.abs = true;
...
class Truck extends Factory {
  constructor(model, color, enginesize, hitch, bed, navigation, backupcamera, audio, warranty, trim, doors){
    super(model, color, enginesize, hitch, bed, navigation, backupcamera, audio, warranty, trim, doors);
    this.model = "Trailblazer";
    this.color = "blue";
    this.enginesize = 8;
    this.hitch = true;
    this.bed = "Standard";
